...
<article <?php post_class('col-md-6 mb-3'); ?> id="post-<?php the_ID(); ?>">
	...
	<div class="media">
		...
		<a class="mr-3 img-grow" href="<?php the_permalink(); ?>">
			<img src="<?php echo get_the_post_thumbnail_url(get_the_ID(),'thumbnail'); ?>" alt="" class="l-w-90 l-h-50">
		</a>

		<div class="media-body">
			<?php the_title( sprintf( '<a class="text-dark" href="%s" rel="bookmark">', esc_url( get_permalink() ) ),
			'</a>' ); ?>
		</div>
